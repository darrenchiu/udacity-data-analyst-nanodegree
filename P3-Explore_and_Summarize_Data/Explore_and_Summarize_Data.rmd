...
acidity, citric acid, residual sugar, free sulfur dioxide), let's try to plot the interested fields individually.
...
will take total.sulfur.dioxide.log to represent all three sulfur fields, and pH to
...
total.sulfur.dioxide.log field but this field also have a weak correlation with the
quality variable.
...
in both sulphates and free.sulfur.dioxide.log level. Let's try to create a 
...
free.sulfur.dioxide.log complement of each other?
...
proved wrong) and total.sulfur.dioxide.log could be used to sum up all 
