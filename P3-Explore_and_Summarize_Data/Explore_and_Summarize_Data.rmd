...
```{r echo=FALSE}
ggplot(aes(x = quality), data = redWineData) +
...
```{r echo=FALSE}
ggplot(aes(x = chlorides), data = redWineData) +
  geom_histogram(binwidth = 0.01)

ggplot(aes(x = density), data = redWineData) +
...
```{r echo=FALSE}
acidP1 <- ggplot(aes(x = fixed.acidity, y = pH), data=redWineData) +
  geom_point(alpha = 1/10) +
  geom_line() +
  geom_smooth(alpha=.2, size=1)

acidP2 <- ggplot(aes(x = volatile.acidity, y = pH), data=redWineData) +
  geom_point(alpha = 1/10) +
  geom_line() +
  geom_smooth(alpha=.2, size=1)

acidP3 <- ggplot(aes(x = citric.acid, y = pH), data=redWineData) +
  geom_point(alpha = 1/10) +
  geom_line() +
  geom_smooth(alpha=.2, size=1)
...
```{r echo=FALSE}
qualityP1 <- ggplot(aes(x = alcohol, y = quality), data=redWineData) +
