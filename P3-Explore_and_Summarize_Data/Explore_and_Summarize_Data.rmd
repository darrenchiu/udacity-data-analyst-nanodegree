...
```{r echo=FALSE}
redWineData['bound.sulfur.dioxide'] = redWineData['total.sulfur.dioxide'] - redWineData['free.sulfur.dioxide']
```
...
Before we move on to the bivariate analysis, we would also like to take a look at the few observations with highest quality (quality>=7).

```{r echo=FALSE}
subset(redWineData, quality > 7)
```
